...
import { SITE_CONFIG, getWhatsAppLink, getJourneyWhatsAppLink, getTelLink } from '../data/siteConfig';
...
export const PHONE_NUMBER = SITE_CONFIG.phoneNumber;
...
export { getWhatsAppLink, getTelLink };
