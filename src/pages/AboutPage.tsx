      ...
      <main>
        ...
        <section className="border-t border-[#C9A24A]/20 bg-[#0B0E13]"><div className="mx-auto max-w-7xl px-4 py-20 text-center sm:px-6 sm:py-24 lg:px-8">
          ...
          <div className="mt-9 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
            <Link to="/packages" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[#C9A24A] px-7 py-3.5 text-xs font-bold uppercase tracking-widest text-[#080B0F] transition-all hover:brightness-110 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#C9A24A]">View Jaisalmer Packages <ArrowUpRight className="h-4 w-4" aria-hidden="true" /></Link>
            <Link to="/plan-journey" className="inline-flex min-h-12 items-center justify-center rounded-full border border-[#C9A24A]/55 bg-[#080B0F] px-7 py-3.5 text-xs font-bold uppercase tracking-widest text-[#D8B982] transition-colors hover:bg-[#C9A24A] hover:text-[#080B0F]">Plan a Journey</Link>
