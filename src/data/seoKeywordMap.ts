...
export const SEO_KEYWORD_MAP: SeoKeywordTarget[] = [
  { path: '/', primaryKeyword: 'Jaisalmer travel agency', secondaryKeywords: ['Jaisalmer tourism services', 'custom Jaisalmer tours'], intent: 'local-commercial', internalLinkTargets: ['/jaisalmer', '/packages', '/safari', '/jaisalmer-taxi'] },
  { path: '/jaisalmer', primaryKeyword: 'Jaisalmer travel guide', secondaryKeywords: ['Jaisalmer tourism', 'Jaisalmer tours', 'Jaisalmer trip'], intent: 'commercial', internalLinkTargets: ['/packages', '/jaisalmer/explore', '/jaisalmer/itinerary', '/jaisalmer/safari-adventure', '/jaisalmer-taxi'] },
  ...
  { path: '/jaisalmer/itinerary', primaryKeyword: 'Jaisalmer itinerary', secondaryKeywords: ['Jaisalmer 2 day itinerary', 'Jaisalmer 3 day itinerary', 'Jaisalmer 4 day itinerary'], intent: 'informational', internalLinkTargets: ['/jaisalmer/explore', '/packages', '/safari', '/jaisalmer-taxi', '/plan-journey'] },
